    ...
    <div class="container">
        ...
        <div class="carousel-container">
            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item">
                        <img class="d-block w-100" src="inasa.jpg" alt="Third slide">
                    </div>
                </div>
        ...
        <div id="popup2" class="popup">
            <div class="popup-content">
                ...
                <!-- -------------------------------------------------------------------------------- -->
                    <a href="https://www.yoshinogari.jp/" target="_blank"><img src="logo.svg" alt="Group 1" class="group-image"></a>
        ...
        <div id="popup3" class="popup">
            <div class="popup-content">
                ...
                <!-- ------------------------------------------------------------------------------- -->
                <div class="image-gallery">
                    <img src="yosinogari.jpg" alt="Background 1" class="bg-image" data-bg-url="yosinogari.jpg">
